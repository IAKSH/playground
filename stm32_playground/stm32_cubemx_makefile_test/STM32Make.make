...
# target
######################################
TARGET = stm32_cubemx_makefile_test
...
GCC_PATH="D:/Programming-Tools/gcc-arm-none-eabi-10.3-2021.10/bin
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"D:/PROGRAMMING-TOOLS/OPENOCD/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"D:/PROGRAMMING-TOOLS/OPENOCD/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32f4x mass_erase 0; exit"
