...
GCC_PATH="D:/PROGRAMMING-TOOLS/EMBEDDED/ARM-GNU-TOOLCHAIN-13.2.REL1-MINGW-W64-I686-ARM-NONE-EABI/BIN
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"D:/PROGRAMMING-TOOLS/EMBEDDED/OPENOCD/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"D:/PROGRAMMING-TOOLS/EMBEDDED/OPENOCD/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32f4x mass_erase 0; exit"
