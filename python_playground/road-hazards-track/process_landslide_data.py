...
def split_files(image_folder,label_folder, train_image_folder, train_label_folder, val_image_folder, val_label_folder, ratio):
    for folder in [train_label_folder, val_label_folder]:
...
def process_landslide():
    output_path = 'datasets/landslide-fixed'
